<?php
    ...
    class Shield extends Creature {
        function Shield( String $cardName = 'defaultTitle', String $cardImg = './defaultImg.jpeg', String $cardDesc = 'defaultDesc', Int $cardManaCost = 0, int $cardAtk = 0, int $cardHp = 0 ) {
    ...
    class Spell extends Card {
        function Spell( String $cardName = 'defaultTitle', String $cardImg = './defaultImg.jpeg', String $cardDesc = 'defaultDesc', Int $cardManaCost = 0, String $cardEffect = 'none' ) {
    ...
    class Special extends Card {
        function Special( String $cardName = 'defaultTitle', String $cardImg = './defaultImg.jpeg', String $cardDesc = 'defaultDesc', Int $cardManaCost = 0, String $cardEffect = 'none' ) {
